...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'read_default_file' : '/afs/athena.mit.edu/activity/s/sbc/.my.cnf',
        },                    
...
ALLOWED_HOSTS = ['mitsbc.mit.edu','sbc.scripts.mit.edu','mit-sbc.org']
...
SECRET_KEY = 'kl%-&o8s2v4jd$-bktmkh+%2#&g&o&*_qk7et2z-0=1why2_v1'
