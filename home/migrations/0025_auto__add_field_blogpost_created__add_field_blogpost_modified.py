...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'home_blogpost', 'created',
        ...
        db.add_column(u'home_blogpost', 'modified',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'home_blogpost', 'created')

        # Deleting field 'BlogPost.modified'
        db.delete_column(u'home_blogpost', 'modified')
