...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'home_slideritem', 'order',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'home_slideritem', 'order')
    ...
    models = {
        ...
        u'home.calendaritem': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '200'}),
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 11, 0, 0)'})
        },
        u'home.contactgroup': {
