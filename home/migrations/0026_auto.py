...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field sub on 'MenuItem'
        m2m_table_name = db.shorten_name(u'home_menuitem_sub')
    ...
    def backwards(self, orm):
        # Removing M2M table for field sub on 'MenuItem'
        db.delete_table(db.shorten_name(u'home_menuitem_sub'))
    ...
    models = {
        ...
        u'home.menuitem': {
            ...
            'sub': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'sub_rel_+'", 'to': u"orm['home.MenuItem']"}),
