...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Subscriber.subscribed'
        db.delete_column(u'home_subscriber', 'subscribed')

        # Adding field 'Subscriber.date'
        db.add_column(u'home_subscriber', 'date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2013, 12, 28, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Subscriber.subscribed'
        db.add_column(u'home_subscriber', 'subscribed',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2013, 12, 28, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'Subscriber.date'
        db.delete_column(u'home_subscriber', 'date')
