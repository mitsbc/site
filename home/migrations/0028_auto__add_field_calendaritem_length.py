...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CalendarItem.length'
        db.add_column(u'home_calendaritem', 'length',
                      self.gf('django.db.models.fields.IntegerField')(default=120),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CalendarItem.length'
        db.delete_column(u'home_calendaritem', 'length')
    ...
    models = {
        ...
        u'home.calendaritem': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'length': ('django.db.models.fields.IntegerField', [], {'default': '120'}),
            'link': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'location': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'new_page': ('django.db.models.fields.BooleanField', [], {}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '200'}),
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 23, 0, 0)'})
        },
        u'home.contactgroup': {
        ...
        u'home.slideritem': {
            'Meta': {'ordering': "['-order']", 'object_name': 'SliderItem'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
