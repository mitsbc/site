...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CalendarItem.time'
        db.alter_column(u'home_calendaritem', 'time', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'CalendarItem.time'
        db.alter_column(u'home_calendaritem', 'time', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        u'home.calendaritem': {
            ...
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 15, 0, 0)'})
        },
        u'home.menu': {
