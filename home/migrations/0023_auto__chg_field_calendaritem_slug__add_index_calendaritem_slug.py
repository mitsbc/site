...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CalendarItem.slug'
        db.alter_column(u'home_calendaritem', 'slug', self.gf('django.db.models.fields.SlugField')(default=None, max_length=200))
        # Adding index on 'CalendarItem', fields ['slug']
        db.create_index(u'home_calendaritem', ['slug'])


    def backwards(self, orm):
        # Removing index on 'CalendarItem', fields ['slug']
        db.delete_index(u'home_calendaritem', ['slug'])


        # Changing field 'CalendarItem.slug'
        db.alter_column(u'home_calendaritem', 'slug', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
