...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CalendarItem.description'
        db.add_column(u'home_calendaritem', 'description',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CalendarItem.description'
        db.delete_column(u'home_calendaritem', 'description')
