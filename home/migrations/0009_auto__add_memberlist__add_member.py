...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field members on 'MemberList'
        m2m_table_name = db.shorten_name(u'home_memberlist_members')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('memberlist', models.ForeignKey(orm[u'home.memberlist'], null=False)),
            ('menu', models.ForeignKey(orm[u'home.menu'], null=False))
        ))
        db.create_unique(m2m_table_name, ['memberlist_id', 'menu_id'])

        # Adding model 'Member'
        db.create_table(u'home_member', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ...
        db.send_create_signal(u'home', ['Member'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field members on 'MemberList'
        db.delete_table(db.shorten_name(u'home_memberlist_members'))

        # Deleting model 'Member'
        db.delete_table(u'home_member')
    ...
    models = {
        ...
        u'home.memberlist': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'members': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'members'", 'symmetrical': 'False', 'to': u"orm['home.Menu']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
        u'home.menu': {
