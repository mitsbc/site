...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DropEvent.ends'
        db.add_column(u'drop_dropevent', 'ends',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 11, 23, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DropEvent.ends'
        db.delete_column(u'drop_dropevent', 'ends')
