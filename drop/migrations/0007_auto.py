...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field resumes on 'ResumeBook'
        m2m_table_name = db.shorten_name(u'drop_resumebook_resumes')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('resumebook', models.ForeignKey(orm[u'drop.resumebook'], null=False)),
            ('resume', models.ForeignKey(orm[u'drop.resume'], null=False))
        ))
        db.create_unique(m2m_table_name, ['resumebook_id', 'resume_id'])


    def backwards(self, orm):
        # Removing M2M table for field resumes on 'ResumeBook'
        db.delete_table(db.shorten_name(u'drop_resumebook_resumes'))
